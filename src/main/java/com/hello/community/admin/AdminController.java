...
@PreAuthorize("hasRole('ADMIN')")   // 전체 관리자 전용
public class AdminController {
    ...
    public String members(@RequestParam(defaultValue = "1") int page,
        ...
        Page<Member> memberPage =
                memberRepository.findAll(PageRequest.of(page - 1, pageSize));
        ...
        return "admin/members";   // 만들게 될 HTML
    }
    ...
    public String memberComments(@PathVariable Long id,
        ...
        return "admin/member-comments"; // 만들 HTML
    }
