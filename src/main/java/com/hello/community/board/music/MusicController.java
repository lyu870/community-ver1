...
public class MusicController {
    ...
    public String listPage(@PathVariable int num,
        ...
        int pageSize = 10;
        Page<Music> page = musicService.findPage(num, pageSize);

        List<Music> items = page.getContent();
    ...
    public String myListPage(@PathVariable int num,
        ...
        int pageSize = 10;
        Page<Music> page = musicService.findMyPage(user.getId(), num, pageSize);
    ...
    public String detail(@PathVariable Long id,
        ...
        return "board/music/detail";
    }

    @GetMapping("/write")
    public String writeForm() {
        return "board/music/write";
    }
    ...
    public String editForm(@PathVariable Long id,
        ...
        if (!music.getWriter().getId().equals(user.getId())) {
            return "redirect:/music/detail/" + id;
        }

        model.addAttribute("data", music);
        return "board/music/edit";
    }
    ...
    public String edit(@RequestParam Long id,
        ...
        musicService.editMusic(id, title, content, user.getId());
        return "redirect:/music/detail/" + id;
    }
    ...
    public String postSearch(@RequestParam(required = false) String searchText,
        ...
        return "redirect:/music/search/page/1?q=" + encoded;
    }
    ...
    public String getSearchPage(@PathVariable int num,
        ...
        Page<Music> page =
                musicService.search(q, num, pageSize);
